 // pages/cheapmarket/details/details.js
...
Page({
    ...
    onShareAppMessage: function () {
        ...
        return {
            ...
            path: '/pages/cheapmarket/details/details?id=' + page.data.goods.id + '&user_id='+ user_info.id,
                ...
                if (res.code == 0) {
                    ...
                    wx.showModal({
                        ...
                        success: function (res) {
                            if (res.confirm) {
                                wx.redirectTo({
                                    url: '/pages/cheapmarket/index/index'
                                });
                            }
                        }
                    });
    ...
    bespeakNow:function(e){
        ...
        if(user_info && user_info.id!= "undefined"&& user_info.id!= 0&& user_info.id!= undefined){
            wx.redirectTo({
                url: '/pages/cheapmarket/submit/submit?id=' + this.data.goods.id,
            });
        }else {
            wx.showLoading({
                title: "请登入",
    ...
    getCommentList: function (more) {
        ...
        app.request({
            url: api.cheapmarket.goods_comment,
            data: {
    ...
    getGoodsQrcode: function () {
        ...
        if (page.data.goods_qrcode)
            return true;
        app.request({
            url: api.cheapmarket.goods_qrcode,
            data: {
                goods_id: page.data.id,
            },
            success: function (res) {
