// pages/cheapmarket/order/order.js
...
Page({
  ...
  onReachBottom: function () {
      ...
      is_loading = true;
      app.request({
          url: api.cheapmarket.order_list,
          data: {
  ...
  onShareAppMessage: function () {
    ...
    orderCancel:function(e)
    {
        ...
        app.request({
            ...
            success: function (res) {
                if (res.code == 0) {
                    wx.redirectTo({
                        url: '/pages/cheapmarket/order/order?status=0'
                    })
                }
            },
            complete: function () {
        ...
        app.request({
            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    wx.redirectTo({
                        url: "/pages/cheapmarket/order/order?status=1",
                    });
    ...
    goToDetails:function(e){
        console.log(e);
        wx.navigateTo({
            url: '/pages/cheapmarket/order/details?oid=' + e.currentTarget.dataset.id,
        });
    },
    /**
     * 核销码
    ...
    applyRefund:function(e)
    {
        ...
        app.request({
            url: api.cheapmarket.apply_refund,
            data: {
                order_id: id
            },
            success: function (res) {
                if (res.code == 0) {
                    wx.showModal({
                        ...
                        success: function (res) {
                            if (res.confirm) {
                                wx.redirectTo({
                                    url: "/pages/cheapmarket/order/order?status=3",
                                });
                            }
                        }
                    })
