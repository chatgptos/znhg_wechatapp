                            ...
                            if (res.code == 0) {
                                wx.showModal({
                                    ...
                                    success: function (res) {
                                        if (res.confirm) {
                                            wx.redirectTo({
                                                url: "/pages/crowdc/order/order?status=5",
                                            });
                                        }
                                    }
                                });
                                ...
                                //                     if (res.confirm) {
                                //                         wx.redirectTo({
                                //                             url: "/pages/crowdc/order/order?status=0",
                                //                         });
                                //                     }
                                //                 }
                                //             });
                                ...
                                //             } else {
                                //                 wx.redirectTo({
                                //                     url: "/pages/crowdc/order/order?status=-1",
                                //                 });
                                //             }
                                //             return;
                                //         }
