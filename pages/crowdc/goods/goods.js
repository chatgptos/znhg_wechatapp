...
Page({
    ...
    submit: function (type) {
        ...
        //     });
        //     wx.redirectTo({
        //         url: "/pages/crowdc/order-submit/order-submit?goods_info=" + JSON.stringify({
        //             goods_id: page.data.id,
    ...
    attrClick: function (e) {
        ...
        app.request({
            url: api.crowdc.goods_attr_info,
            data: {
            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    goods.coupon = res.data.coupon;
                    goods.integral_buy = res.data.integral_buy;
                    goods.seckill_coupon = res.data.seckill_coupon;
                    goods.seckill_integral_buy = res.data.seckill_integral_buy;
    ...
    onShareAppMessage: function () {
        ...
        var user_info = wx.getStorageSync("user_info");
        var res = {
            path: "/pages/crowdc/goods/goods?id=" + this.data.id + "&user_id=" + user_info.id,
            success: function (e) {
                console.log(e);
                share_count++;
                if (share_count == 1)
    ...
    setseckillTimeOver: function () {
        ...
        function _init() {
            ...
            var time_over_crowd = page.data.goods.seckill.end_time_crowdc - page.data.goods.seckill.now_time;
            time_over_crowd = time_over_crowd < 0 ? 0 : time_over_crowd;
            page.setData({
                crowdc_end_time_over: secondToTime(time_over_crowd),
            });
        }
