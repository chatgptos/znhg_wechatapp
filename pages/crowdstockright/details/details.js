 // pages/crowdstockright/details/details.js
...
Page({
    ...
    onShareAppMessage: function () {
        ...
        return {
            ...
            path: '/pages/crowdstockright/details/details?id=' + page.data.goods.id + '&user_id='+ user_info.id,
    ...
    getGoodsInfo: function (e) {
        ...
        app.request({
            url: api.crowdstockright.details,
            method: "get",
            data: { gid: gid },
            success: function (res) {
                if (res.code == 0) {
                    ...
                    wx.showModal({
                        ...
                        success: function (res) {
                            if (res.confirm) {
                                wx.redirectTo({
                                    url: '/pages/crowdstockright/index/index'
                                });
                            }
                        }
                    });
    ...
    bespeakNow:function(e){
        wx.redirectTo({
            url: '/pages/crowdstockright/submit/submit?id=' + this.data.goods.id,
        });
    },
    /**
     * 货柜列表
    ...
    getCommentList: function (more) {
        ...
        app.request({
            url: api.crowdstockright.goods_comment,
            data: {
    ...
    getGoodsQrcode: function () {
        ...
        if (page.data.goods_qrcode)
            return true;
        app.request({
            url: api.crowdstockright.goods_qrcode,
            data: {
                goods_id: page.data.id,
            },
            success: function (res) {
