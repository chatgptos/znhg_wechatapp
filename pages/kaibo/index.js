...
Page({
    ...
    onLoad: function (options) {
        ...
        app.request({
            url: api.default.kaibo_comment_preview,
            data: {
                order_id: options.id,
            },
    ...
    commentSubmit: function (e) {
        ...
        function uploadImages(i) {
            ...
            for (var j in goods_list[i].pic_list) {
                (function (j) {
                    wx.uploadFile({
                        url: api.default.upload_image_get_mediaid,
                        formData:{'store_id':1},
                        name: "image",
                        ...
                        complete: function (e) {
                            if (e.data) {
                                ...
                                if (res.code == 0) {
                                    ...
                                    goods_list[i].media_id[j] = res.data.data.media_id;
                                }
                            }
                            complete_count++;
