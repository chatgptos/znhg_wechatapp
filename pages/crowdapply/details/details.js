 // pages/crowdapply/details/details.js
...
Page({
    ...
    onShareAppMessage: function () {
        ...
        return {
            ...
            path: '/pages/crowdapply/details/details?id=' + page.data.goods.id + '&user_id='+ user_info.id,
                ...
                if (res.code == 0) {
                    ...
                    wx.showModal({
                        ...
                        success: function (res) {
                            if (res.confirm) {
                                wx.redirectTo({
                                    url: '/pages/crowdapply/index/index'
                                });
                            }
                        }
                    });
    ...
    bespeakNow:function(e){
        wx.redirectTo({
            url: '/pages/crowdapply/submit/submit?id=' + this.data.goods.id,
        });
    },
    /**
     * 货柜列表
    ...
    getCommentList: function (more) {
        ...
        app.request({
            url: api.crowdapply.goods_comment,
            data: {
    ...
    getGoodsQrcode: function () {
        ...
        if (page.data.goods_qrcode)
            return true;
        app.request({
            url: api.crowdapply.goods_qrcode,
            data: {
                goods_id: page.data.id,
            },
            success: function (res) {
