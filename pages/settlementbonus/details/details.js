 // pages/settlementbonus/details/details.js
...
Page({
    ...
    onShareAppMessage: function () {
        ...
        return {
            ...
            path: '/pages/settlementbonus/details/details?id=' + page.data.goods.id + '&user_id='+ user_info.id,
    ...
    getGoodsInfo: function (e) {
        ...
        app.request({
            url: api.settlementbonus.details,
            method: "get",
            data: { gid: gid },
            success: function (res) {
                if (res.code == 0) {
                    ...
                    wx.showModal({
                        ...
                        success: function (res) {
                            if (res.confirm) {
                                wx.redirectTo({
                                    url: '/pages/settlementbonus/index/index'
                                });
                            }
                        }
                    });
    ...
    bespeakNow:function(e){
        wx.redirectTo({
            url: '/pages/settlementbonus/submit/submit?id=' + this.data.goods.id,
        });
    },
    /**
     * 货柜列表
    ...
    goToShopList: function (e) {
        wx.navigateTo({
            url: '/pages/settlementbonus/shop/shop?ids=' + this.data.goods.shop_id,
            success: function(res) {},
            fail: function(res) {},
            complete: function(res) {},
        });
    ...
    getCommentList: function (more) {
        ...
        app.request({
            url: api.settlementbonus.goods_comment,
            data: {
    ...
    getGoodsQrcode: function () {
        ...
        if (page.data.goods_qrcode)
            return true;
        app.request({
            url: api.settlementbonus.goods_qrcode,
            data: {
                goods_id: page.data.id,
            },
            success: function (res) {
