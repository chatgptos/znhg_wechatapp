...
Page({
    ...
    submit: function (type) {
        ...
        //     });
        //     wx.redirectTo({
        //         url: "/pages/bookmall/order-submit/order-submit?goods_info=" + JSON.stringify({
        //             goods_id: page.data.id,
    ...
    attrClick: function (e) {
        ...
        app.request({
            url: api.bookmall.goods_attr_info,
            data: {
    ...
    onShareAppMessage: function () {
        ...
        var user_info = wx.getStorageSync("user_info");
        var res = {
            path: "/pages/bookmall/goods/goods?id=" + this.data.id + "&user_id=" + user_info.id,
            success: function (e) {
                console.log(e);
                share_count++;
                if (share_count == 1)
