...
Page({
    ...
    orderSubmit: function () {
        ...
        var data = {};
        if (page.data.yushouxuzhi_radio !=1) {
            wx.showToast({
                title: "请点击预售须知并同意",
                image: "/images/icon-warning.png",
            });
        ...
        page.data.integral_radio == 1 ? data.use_integral = 2 : data.use_integral = 1;
        page.data.yushouxuzhi_radio == 1 ? data.yushouxuzhi_radio = 2 : data.yushouxuzhi_radio = 1;
        //提交订单
        app.request({
            url: api.bookmall.submit,
            method: "post",
            data: data,
                    ...
                    app.request({
                        ...
                        success: function (res) {
                            if (res.code == 0) {
                                ...
                                //                     if (res.confirm) {
                                //                         wx.redirectTo({
                                //                             url: "/pages/bookmall/order/order?status=0",
                                //                         });
                                //                     }
                                //                 }
                                //             });
                                ...
                                //             } else {
                                //                 wx.redirectTo({
                                //                     url: "/pages/bookmall/order/order?status=-1",
                                //                 });
                                //             }
                                //             return;
                                //         }
    ...
    getOrderData: function (options) {
        ...
        if (options.cart_id_list) {
            ...
            app.request({
                url: api.bookmall.submit_preview,
                data: {
                ...
                success: function (res) {
                    ...
                    if (res.code == 0) {
                        page.setData({
                            ...
                            form: res.data.form,
                            advance_coupon: res.data.advance_coupon,
                            advance_integral_buy: res.data.advance_integral_buy,
                            yukuan_coupon: res.data.yukuan_coupon,
                            yukuan_integral_buy: res.data.yukuan_integral_buy,
                            chargeprice: res.data.chargeprice,
                            seckill_data: res.data.seckill_data,
                        });
    ...
    integralSwitchChangeyushouxuzhi_radio: function (e) {
        var page = this;
        if (e.detail.value != false) {
            page.setData({
                yushouxuzhi_radio: 1,
    ...
    integrationyushouxuzhi: function (e) {
        var page = this;
        var integration = page.data.integral.integrationyushou;
        wx.showModal({
            title: '预售使用条款',
            content: integration,
            showCancel: false,
